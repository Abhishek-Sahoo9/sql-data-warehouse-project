...
--	ca.gen (CRM is the master for gender info.. The ci & ca gender info display different results, therefore they couldn't be grouped up)
...
--	pn.prd_end_dt    always null because of the WHERE clause
